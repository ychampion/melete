...
The unclaimed engine capability is **production stdio launch**. Stdio recovery
and refresh are tested with explicit fixtures; the service refuses to launch an
