...
- Finding 6: artifactValidation adds optional validated_content_hash; migration 0016_artifact_content_digest adds the nullable storage column. Historical rows without a digest require fresh validation. Completion hashes current bytes, and mutation receipts preserve existing declarations in new validation rows.
