...
test('"It did not" is described by the retry hint before the choice', () => {
  ...
  expect(RETRY_HINT).toBe('Melete may try this again.');
  expect(html).toContain('If it did not, Melete may try this again.');
...
test('once the person says it did not, the card says Melete may try again', () => {
