        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            agents: components["schemas"]["__schema193"][];
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
        };
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["__schema204"] | components["schemas"]["__schema176"];
                    };
                };
            };
        };
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            templates: {
                                agent: {
                                    allowed_connection_ids: components["schemas"]["__schema201"];
                                    asks_before_acting: components["schemas"]["__schema202"];
                                    colour: components["schemas"]["__schema196"];
                                    eye_colour: components["schemas"]["__schema198"];
                                    face_image?: components["schemas"]["__schema203"];
                                    name: components["schemas"]["__schema194"];
                                    role: components["schemas"]["__schema195"];
                                    standing_instruction: components["schemas"]["__schema200"];
                                    surface: components["schemas"]["__schema197"];
                                    tone: components["schemas"]["__schema199"];
                                };
                                id: components["schemas"]["__schema170"];
                                title: components["schemas"]["__schema171"];
                            }[];
                        } | components["schemas"]["__schema176"];
                    };
                };
                    ...
                    content: {
                        "application/json": {
                            approvals: {
                                action_id: string;
                                approval_id: string;
                                canonical_payload: components["schemas"]["__schema243"];
                                connection_id: string;
                                effect_class: components["schemas"]["EffectClass"];
                                expires_at: components["schemas"]["__schema113"] | null;
                                job_id: string;
                                job_revision: number;
                                kind: string;
                                /** @default [] */
                                origin_warnings: {
                                    ...
                                    field: string;
                                    handle: string | null;
                                    origin_trust: components["schemas"]["__schema254"];
                                }[];
                                payload_hash: components["schemas"]["__schema300"];
                                requested_at: components["schemas"]["__schema113"];
                            }[];
                        };
                    };
                };
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            action_id: string;
                            approval_id: string;
                            decided_at: components["schemas"]["__schema113"];
                            /** @enum {string} */
                            decision: "approved" | "denied";
                            payload_hash: components["schemas"]["__schema300"];
                        };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            automations: components["schemas"]["__schema212"][];
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["__schema213"] | components["schemas"]["__schema176"];
                    };
                };
            };
        };
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["__schema192"] | components["schemas"]["__schema176"];
                    };
                };
            };
        };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["__schema214"] | components["schemas"]["__schema176"];
                    };
                };
            };
        };
        ...
        get: {
            parameters: {
                query: {
                    ...
                    after?: components["schemas"]["__schema85"];
                    /** @description The live id this view was opened with */
                    live_id: components["schemas"]["__schema84"];
                };
                header?: never;
                path: {
                    /** @description Browser session id returned by browser.observe */
        ...
        post: {
            ...
            requestBody?: {
                content: {
                    "application/json": {
                        ack_through: number;
                        events: components["schemas"]["__schema86"][];
                        live_id: components["schemas"]["__schema84"];
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            conversations: components["schemas"]["__schema169"][];
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["__schema177"] | components["schemas"]["__schema176"];
                    };
                };
            };
        };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            cards: components["schemas"]["__schema181"][];
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            drafts: components["schemas"]["__schema187"][];
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
                        ...
                        "application/json": {
                            events: {
                                ...
                                item: ({
                                    ...
                                    label: components["schemas"]["__schema171"];
                                    meta: string;
                                    sources: {
                                        app: components["schemas"]["__schema171"];
                                        connection_id: components["schemas"]["__schema170"];
                                        /** @enum {string} */
                                        kind: "event" | "message" | "draft" | "file" | "page" | "task";
                                        title: components["schemas"]["__schema171"];
                                        url?: components["schemas"]["__schema178"];
                                    }[];
                                    tool?: components["schemas"]["__schema179"];
                                    /** @constant */
                                    type: "action";
                                } | {
                                    text: components["schemas"]["__schema171"];
                                    /** @constant */
                                    type: "note";
                                } | {
                                    apps: components["schemas"]["__schema171"][];
                                    elapsed_ms: components["schemas"]["__schema175"];
                                    source_count: components["schemas"]["__schema175"];
                                    summary: components["schemas"]["__schema171"];
                                    /** @constant */
                                    type: "done";
                                }) | {
                                    text: string;
                                    ...
                                    card: components["schemas"]["__schema181"];
                                    /** @constant */
                                    type: "card";
                                } | {
                                    receipt: components["schemas"]["__schema184"];
                                    /** @constant */
                                    type: "receipt";
                                } | {
                                    permission: components["schemas"]["__schema185"];
                                    /** @constant */
                                    type: "permission";
                                } | {
                                    question: components["schemas"]["__schema188"];
                                    /** @constant */
                                    type: "question";
                                } | {
                                    decision: {
                                    ...
                                    composer: components["schemas"]["__schema173"];
                                    status: components["schemas"]["__schema172"];
                                    /** @constant */
                                    type: "status";
                                } | {
                                    tool: components["schemas"]["__schema179"];
                                ...
                                seq: components["schemas"]["__schema175"];
                                turn_id: components["schemas"]["__schema170"] | null;
                            }[];
                            has_more: boolean;
                            next_cursor: components["schemas"]["__schema175"];
                        } | components["schemas"]["__schema176"];
                        /**
                         * @example id: 42
                         *     event: say
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            turns: {
                                agent_id: components["schemas"]["__schema170"];
                                answer: string;
                                conversation_id: components["schemas"]["__schema170"];
                                created_at: components["schemas"]["__schema174"];
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            receipt: {
                                id: components["schemas"]["__schema170"];
                                received_at: components["schemas"]["__schema174"];
                                /** @enum {string} */
                                status: "accepted" | "failed_retry";
                            };
                            turn_id: components["schemas"]["__schema170"];
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            draft: components["schemas"]["__schema187"];
                            permission: components["schemas"]["__schema185"] | null;
                            receipt: components["schemas"]["__schema184"] | null;
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            prohibitions: components["schemas"]["__schema140"][];
                        };
                    };
                };
            };
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            prohibition: components["schemas"]["__schema140"];
                        };
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            episodes: components["schemas"]["__schema108"][];
                        };
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            source_connection: components["schemas"]["__schema170"];
                            title: components["schemas"]["__schema171"];
                            updated_at: components["schemas"]["__schema174"];
                            value: components["schemas"]["__schema171"];
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            artist: components["schemas"]["__schema171"];
                            image?: components["schemas"]["__schema178"];
                            playing: boolean;
                            source_connection: components["schemas"]["__schema170"];
                            title: components["schemas"]["__schema171"];
                        } | components["schemas"]["__schema176"];
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            ...
                            /** @enum {string} */
                            status: "ok" | "degraded";
                            time: components["schemas"]["__schema113"];
                            version: string;
                        };
                    };
                };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            date: components["schemas"]["__schema171"];
                            greeting: components["schemas"]["__schema171"];
                            open_task_count: components["schemas"]["__schema175"];
                            tasks: components["schemas"]["__schema210"][];
                            time_zone: components["schemas"]["__schema171"];
                            upcoming: {
                                connection_id: components["schemas"]["__schema170"];
                                ends_at: components["schemas"]["__schema174"];
                                id: components["schemas"]["__schema170"];
                                starts_at: components["schemas"]["__schema174"];
                                title: components["schemas"]["__schema171"];
                                url?: components["schemas"]["__schema178"];
                            }[] | components["schemas"]["__schema176"];
        ...
        post: {
            ...
            responses: {
                ...
                400: {
                    ...
                    content: {
                        "application/json": components["schemas"]["__schema215"] | components["schemas"]["__schema142"];
                    };
                };
        ...
        post: {
            ...
            responses: {
                ...
                201: {
                    ...
                    content: {
                        "application/json": {
                            episode: components["schemas"]["__schema108"];
                        };
                    };
                };
            };
        ...
        put: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            createdAt: components["schemas"]["__schema113"];
                            inputRefs: string[];
                            jobId: string;
                            scope: components["schemas"]["__schema110"];
                            spaceId: string;
                            templateId: string;
                        };
                    };
                        ...
                        "application/json": {
                            ...
                            repairs: {
                                ...
                                candidates: {
                                    action_id: string;
                                    connection_id: string;
                                    created_at: components["schemas"]["__schema113"];
                                    /** @default null */
                                    evaluation: {
                                        detail: string;
                                        evaluated_at: components["schemas"]["__schema113"];
                                        passed: boolean;
                                    } | null;
                                    fault_kind: components["schemas"]["__schema305"];
                                    id: string;
                                    job_id: string;
                                    kind: string;
                                    /** @default null */
                                    observed_schema: components["schemas"]["__schema243"] | null;
                                    proposed_mapping: {
                                        [key: string]: string;
                                    };
                                    safe: boolean;
                                    ...
                                    test: {
                                        expected: components["schemas"]["__schema243"];
                                        input: components["schemas"]["__schema243"];
                                        name: string;
                                        operation: string;
                                        /** @default [] */
                                        preserves: {
                                    ...
                                    updated_at: components["schemas"]["__schema113"];
                                }[];
                                /** @default {} */
                                counters: components["schemas"]["__schema303"];
                                /** @default null */
                                disposition: components["schemas"]["__schema302"] | null;
                                effect_class: components["schemas"]["EffectClass"];
                                /** @default null */
                                intent_key: components["schemas"]["__schema301"] | null;
                                job_id: string;
                                kind: string;
                                payload_hash: components["schemas"]["__schema300"];
                                /** @default null */
                                retry_after_at: components["schemas"]["__schema113"] | null;
                                safe_stop: boolean;
                                status: components["schemas"]["ActionStatus"];
                                /** @default [] */
                                trace: components["schemas"]["__schema304"];
                            }[];
                        };
                    };
                };
                        ...
                        "application/json": {
                            trigger: {
                                ...
                                spec: {
                                    ...
                                    poll_seconds: number;
                                    predicate: {
                                        all: components["schemas"]["__schema279"][];
                                    };
                                };
                            };
                        };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            proposals: components["schemas"]["__schema275"][];
                        };
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            items: components["schemas"]["__schema132"][];
                            last_change: components["schemas"]["__schema134"] | null;
                        };
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            notices: components["schemas"]["__schema136"][];
                        };
                    };
                };
            };
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            episode_id: components["schemas"]["__schema109"] | null;
                            item: components["schemas"]["__schema132"] | null;
                            notice: components["schemas"]["__schema136"];
                        };
                    };
                };
            };
        ...
        get: {
            parameters: {
                query?: {
                    ...
                    space_id?: components["schemas"]["__schema93"];
                };
                header?: never;
                path: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            company: components["schemas"]["__schema405"];
                            item: components["schemas"]["__schema408"];
                            message: {
                                from: string;
                                id: string;
                                received_at: string;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            attributed: boolean;
                            findings: components["schemas"]["__schema270"][];
                        };
                    };
                };
            };
                    ...
                    content: {
                        "application/json": {
                            claims: {
                                ...
                                current: components["schemas"]["__schema263"];
                                domain_key: components["schemas"]["__schema250"];
                                head_revision: components["schemas"]["__schema251"];
                                hidden: components["schemas"]["__schema267"];
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            ...
                            revisions: components["schemas"]["__schema263"][];
                        };
                    };
                };
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            contradictions: {
                                alternative: components["schemas"]["__schema257"];
                                /** @enum {string} */
                                audience: "private" | "space" | "public";
                                claim_id: string;
                                head: components["schemas"]["__schema257"];
                                id: components["schemas"]["__schema268"];
                                key: components["schemas"]["__schema258"];
                                question_id: components["schemas"]["__schema268"] | null;
                                recorded_at: components["schemas"]["__schema113"];
                                space_id: string;
                                /** @enum {string} */
                                state: "open" | "resolved";
                            }[];
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            ...
                            next?: components["schemas"]["__schema170"] | null;
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            item: components["schemas"]["__schema205"];
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            output: string | null;
                            reasons: components["schemas"]["__schema171"][];
                            used_at: components["schemas"]["__schema174"] | null;
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            repair_briefs: {
                                affected: components["schemas"]["__schema274"][];
                                changed_handle: components["schemas"]["__schema257"];
                                created_at: components["schemas"]["__schema113"];
                                id: components["schemas"]["__schema268"];
                                job_id: string;
                                key: components["schemas"]["__schema258"] | null;
                                new_value: components["schemas"]["__schema273"];
                                old_value: components["schemas"]["__schema273"];
                                replacement_handle: components["schemas"]["__schema257"] | null;
                            }[];
                        };
                    };
                };
            ...
            responses: {
                ...
                201: {
                    ...
                    content: {
                        "application/json": {
                            attributed: boolean;
                            output_id: components["schemas"]["__schema268"];
                            output_version: components["schemas"]["__schema268"];
                            unknown_handles: components["schemas"]["__schema269"][];
                        };
                    };
                };
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            questions: {
                                because: components["schemas"]["__schema257"][];
                                created_at: components["schemas"]["__schema113"];
                                id: components["schemas"]["__schema268"];
                                if_ignored: string;
                                key: components["schemas"]["__schema258"];
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            coverage: {
                                authoritative_revision: components["schemas"]["__schema253"];
                                indexed_revision: components["schemas"]["__schema253"];
                                /** @enum {string} */
                                reason: "ready" | "index_lag" | "budget" | "timeout" | "index_failure" | "restore_pending" | "public_compartment";
                                supplemented: components["schemas"]["__schema253"];
                                truncated: boolean;
                            };
                            /** @default [] */
                            disputed_keys: components["schemas"]["__schema258"][];
                            index_generation: components["schemas"]["__schema253"] | null;
                            items: {
                                claim_id: components["schemas"]["__schema256"];
                                content: string;
                                /** @default false */
                                disputed: boolean;
                                domain_key: components["schemas"]["__schema250"];
                                excerpts: string[];
                                factual_status: components["schemas"]["__schema260"];
                                handle: components["schemas"]["__schema257"];
                                /** @default null */
                                key: components["schemas"]["__schema258"] | null;
                                ...
                                sources: components["schemas"]["__schema262"][];
                                status: components["schemas"]["__schema261"];
                                superseded_at: components["schemas"]["__schema113"] | null;
                                valid_from: components["schemas"]["__schema113"];
                                valid_until: components["schemas"]["__schema113"] | null;
                            }[];
                            recipe: components["schemas"]["__schema250"];
                            snapshot: components["schemas"]["__schema255"] | null;
                            /** @enum {string} */
                            status: "complete" | "degraded" | "unavailable";
                            token_budget: {
                                /** @enum {string} */
                                counter: "utf8-bytes-upper-bound-v1" | "utf8-bytes-quarter-v1";
                                limit: components["schemas"]["__schema251"];
                    ...
                    content: {
                        "application/json": {
                            rejected: {
                                ...
                                recorded_at: components["schemas"]["__schema113"];
                                work_id: components["schemas"]["__schema268"];
                            }[];
                        };
                    };
                };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["__schema206"] | components["schemas"]["__schema176"];
                    };
                };
            };
        };
        ...
        post: {
            ...
            responses: {
                ...
                201: {
                    ...
                    content: {
                        "application/json": {
                            committed_sequence: components["schemas"]["__schema251"];
                            duplicate: boolean;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            actionable: boolean;
                            fields: components["schemas"]["__schema271"][];
                            minimum_trust: components["schemas"]["__schema254"];
                            unresolved: components["schemas"]["__schema272"][];
                        };
                    };
                };
            };
        ...
        post: {
            ...
            responses: {
                ...
                201: {
                    ...
                    content: {
                        "application/json": {
                            reaction: components["schemas"]["__schema280"];
                        };
                    };
                };
    ...
    "/model-providers/{provider}/sign-in": {
        ...
        get: {
            parameters: {
                ...
                header?: never;
                path: {
                    provider: components["schemas"]["__schema94"];
                };
                cookie?: never;
            };
            requestBody?: never;
            ...
            requestBody?: {
                content: {
                    "application/json": {
                        ...
                        method?: components["schemas"]["__schema95"];
                    };
                };
            };
            responses: {
            ...
            requestBody?: {
                content: {
                    "application/json": {
                        ...
                        callback_url?: components["schemas"]["__schema96"];
                        sign_in_id: string;
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            providers: components["schemas"]["__schema410"][];
                        };
                    };
                };
                /** @description Only the setup owner manages model sign-in */
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            notifications: components["schemas"]["__schema247"][];
                        };
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            operations: components["schemas"]["__schema245"][];
                        };
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            permissions: components["schemas"]["__schema185"][];
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            ...
                            rule: components["schemas"]["__schema191"] | null;
                            /** @constant */
                            status: "ok";
                        } | components["schemas"]["__schema176"];
                    };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            plans: components["schemas"]["__schema207"][];
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["__schema208"] | components["schemas"]["__schema176"];
                    };
                };
            };
        };
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["__schema176"] | components["schemas"]["__schema176"];
                    };
                };
            };
        };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            procedures: components["schemas"]["__schema115"][];
                        };
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["__schema209"] | components["schemas"]["__schema176"];
                    };
                };
            };
        };
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            error?: components["schemas"]["__schema143"];
                            job: components["schemas"]["__schema216"] | null;
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            questions: components["schemas"]["__schema188"][];
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            obligations: components["schemas"]["__schema246"][];
                        };
                    };
                };
            };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            rules: components["schemas"]["__schema191"][];
                        } | components["schemas"]["__schema176"];
                    };
                };
            };
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            results: {
                                conversation_id: components["schemas"]["__schema170"] | null;
                                id: components["schemas"]["__schema170"];
                                /** @enum {string} */
                        ...
                        "application/json": {
                            skills: {
                                ...
                                frontmatter: {
                                    ...
                                    /** @default [] */
                                    tools: string[];
                                    triggers: components["schemas"]["__schema383"][];
                                };
                                id: string;
                                path: string;
        ...
        post: {
            ...
            responses: {
                ...
                201: {
                    ...
                    content: {
                        "application/json": {
                            membership: components["schemas"]["__schema150"];
                        };
                    };
                };
                /** @description Space owner required */
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            companies: components["schemas"]["__schema405"][];
                            currency: components["schemas"]["__schema407"];
                            items: components["schemas"]["__schema408"][];
                            totals: {
                                data_holders: number;
                                monthly_spend_minor: components["schemas"]["__schema406"];
                                owed_to_you_minor: components["schemas"]["__schema406"];
                                price_rises: number;
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            ...
                            note?: components["schemas"]["__schema404"];
                            /** @enum {string} */
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["__schema211"] | components["schemas"]["__schema176"];
                    };
                };
            };
        };
...
export interface components {
    schemas: {
        ...
        __schema86: {
            ...
            /** @enum {string} */
            k: "move" | "down" | "up";
            mods: components["schemas"]["__schema89"];
            x: components["schemas"]["__schema87"];
            y: components["schemas"]["__schema88"];
        } | {
            dx: components["schemas"]["__schema90"];
            dy: components["schemas"]["__schema90"];
            /** @constant */
            k: "wheel";
            mods: components["schemas"]["__schema89"];
            x: components["schemas"]["__schema87"];
            ...
            points: components["schemas"]["__schema91"][];
        };
        __schema87: number;
        __schema88: number;
        __schema89: number;
        ...
        __schema93: string;
        /** @enum {string} */
        __schema94: "chatgpt" | "openai-compatible";
        /** @enum {string} */
        __schema95: "device" | "browser";
        __schema96: string;
        __schema97: string;
        __schema98: number;
        __schema99: string;
        __schema100: string;
        /** @enum {string} */
        __schema101: "on_session_start" | "on_session_end" | "on_session_finalize" | "on_session_reset" | "pre_llm_call" | "post_llm_call" | "pre_tool_call" | "post_tool_call" | "pre_api_request" | "post_api_request" | "api_request_error" | "pre_approval_request" | "post_approval_response" | "subagent_start" | "subagent_stop" | "on_skill_lifecycle" | "on_stream_start" | "on_stream_end" | "pre_verify" | "on_compaction" | "runtime_error";
        __schema102: string | null;
        __schema103: {
            captured_at: components["schemas"]["__schema30"];
            duration_ms: number | null;
        };
        /** @enum {string} */
        __schema104: "started" | "succeeded" | "failed" | "interrupted" | "observed" | "unknown";
        ...
        __schema108: {
            actor: string;
            artifacts: components["schemas"]["__schema112"][];
            correctiveJobId?: string | null;
            createdAt: components["schemas"]["__schema113"];
            expiresAt: components["schemas"]["__schema113"];
            failureClass: string | null;
            generationStartedAt: components["schemas"]["__schema113"] | null;
        ...
        __schema109: string;
        __schema110: {
            app: components["schemas"]["__schema111"];
            app_version: components["schemas"]["__schema111"];
            /** @constant */
            audience: "private";
            /** @constant */
            role: "owner";
            task_family: components["schemas"]["__schema111"];
        };
        __schema111: string;
        __schema112: {
            [key: string]: unknown;
        ...
        __schema113: string;
        __schema114: {
            candidate: components["schemas"]["__schema115"];
        };
        __schema115: {
            body: string;
            bodyHash: string;
            ...
            /** @default {} */
            caseTemplates: {
                final_pool?: components["schemas"]["__schema130"][];
                validation?: components["schemas"]["__schema129"][];
            };
            change: components["schemas"]["__schema112"];
            /** @default [] */
            checks: ({
                kind: components["schemas"]["__schema119"];
                max?: components["schemas"]["__schema121"];
                min?: components["schemas"]["__schema120"];
            } | {
                ...
                phrase: components["schemas"]["__schema128"];
            } | {
                /** @constant */
                ...
                headings: components["schemas"]["__schema128"][];
                /** @constant */
                ...
                key: components["schemas"]["__schema128"];
                /** @constant */
                kind: "records_sorted";
                /** @default true */
                ...
                action_kind: components["schemas"]["__schema128"];
                /** @constant */
            ...
            episodeId: components["schemas"]["__schema109"] | null;
            /** @default [] */
            evidence: components["schemas"]["__schema118"][];
            /** @default null */
            ...
            /** @default null */
            pausedAt: components["schemas"]["__schema113"] | null;
             ...
             */
            promotion: {
                approved_at?: components["schemas"]["__schema113"];
                /** @enum {string} */
            ...
            /** @default null */
            removedAt: components["schemas"]["__schema113"] | null;
            scope: components["schemas"]["__schema110"];
            selectedEvaluationId: string | null;
            /** @default null */
            skillName: string | null;
            spaceId: string;
            state: components["schemas"]["__schema117"];
            tests: string[];
            /** @default [] */
            triggers: {
                evidence: components["schemas"]["__schema118"];
        ...
        __schema116: string;
        /** @enum {string} */
        __schema117: "candidate" | "evaluated" | "enabled_canary" | "active" | "superseded" | "reverted";
        __schema118: {
            end: number;
            /** @constant */
            fallback?: "verbatim";
        ...
        /** @constant */
        __schema119: "word_count";
        __schema120: number;
        __schema121: number;
        /** @constant */
        __schema122: "char_count";
        __schema123: number;
        __schema124: number;
        /** @constant */
        __schema125: "line_count";
        __schema126: number;
        __schema127: number;
        __schema128: string;
        __schema129: string;
        ...
        __schema131: {
            candidate: components["schemas"]["__schema115"];
            evaluations: {
                budget: components["schemas"]["__schema112"];
                createdAt: components["schemas"]["__schema113"];
                id: string;
                passed: boolean;
                phase: string;
                selectedAt: components["schemas"]["__schema113"] | null;
            }[];
            history: {
                actor: string;
                candidateId: components["schemas"]["__schema116"];
                createdAt: components["schemas"]["__schema113"];
                fromState: string | null;
                id: string;
                reason: string;
                toState: components["schemas"]["__schema117"];
            }[];
        };
        __schema132: {
            ...
            id: string;
            learned_at: components["schemas"]["__schema113"];
            name: string;
            reason: string | null;
            reason_code: string | null;
            shared: boolean;
            source: components["schemas"]["__schema133"];
            space_id: string;
            /** @enum {string} */
            state: "proposed" | "trial" | "active" | "paused" | "reverted";
        };
        /** @enum {string} */
        __schema133: "correction" | "engine";
        __schema134: {
            /** @enum {string} */
        ...
        __schema135: {
            change: components["schemas"]["__schema134"] | null;
            item: components["schemas"]["__schema132"] | null;
        };
        __schema136: {
        ...
        __schema137: string;
        __schema138: {
            skills: components["schemas"]["__schema139"][];
        };
        __schema139: {
            body: string;
            created_at: components["schemas"]["__schema113"];
        ...
        __schema140: {
            ...
            name: string;
            reason: string;
            source_skill_id: components["schemas"]["__schema116"] | null;
            space_id: string | null;
        };
        __schema141: {
            skill: components["schemas"]["__schema139"];
        };
        __schema142: {
            error: components["schemas"]["__schema143"];
        };
        ...
        __schema145: string;
        /** @enum {string} */
        __schema146: "personal" | "shared";
        /** @enum {string} */
        __schema147: "owner" | "space";
        __schema148: string | null;
        __schema149: string;
        __schema150: {
            generation: number;
            principal_id: string;
            revoked_at: components["schemas"]["__schema113"] | null;
            /** @enum {string} */
            role: "owner" | "member";
            space_id: string;
        };
        ...
        __schema153: string;
        /** @enum {string} */
        __schema154: "removed" | "emptied";
        /** @enum {string} */
        __schema155: "pending" | "running" | "blocked" | "cleaning" | "complete";
        /** @enum {string} */
        __schema156: "fence" | "sessions" | "journal" | "sandboxes" | "browser" | "runtime" | "files" | "operational" | "principals" | "memory" | "verify" | "space";
        __schema157: {
            /** @default {} */
            cleared: {
                [key: string]: number;
        ...
        __schema159: components["schemas"]["__schema113"] | null;
        __schema160: string;
        __schema161: string;
        __schema162: {
            artifacts: number;
        ...
        __schema169: {
            ...
            created_at: components["schemas"]["__schema174"];
            id: components["schemas"]["__schema170"];
            plan_id: components["schemas"]["__schema170"] | null;
            progress?: {
                current: string | null;
                steps_done: components["schemas"]["__schema175"];
            };
            status: components["schemas"]["__schema172"];
            title: components["schemas"]["__schema171"];
            updated_at: components["schemas"]["__schema174"];
        ...
        __schema171: string;
        /** @enum {string} */
        __schema172: "idle" | "queued" | "working" | "streaming" | "needs_you" | "paused" | "done" | "failed" | "stopped";
        /** @enum {string} */
        __schema173: "send" | "pause" | "resume" | "stop";
        /** Format: date-time */
        __schema174: string;
        __schema175: number;
        __schema176: {
            reason: components["schemas"]["__schema171"];
            /** @constant */
            status: "not_available";
        };
        __schema177: {
            conversation: components["schemas"]["__schema169"];
        };
        /** Format: uri */
        __schema178: string;
        __schema179: {
            ...
            ended_at: components["schemas"]["__schema174"] | null;
            id: components["schemas"]["__schema170"];
            input_summary: components["schemas"]["__schema180"] | null;
            /** @enum {string} */
            kind: "connector" | "web" | "file" | "artifact" | "browser" | "sandbox" | "skill" | "memory_recall" | "memory_write" | "memory_correct" | "memory_forget" | "model" | "retry" | "tool";
            output_summary: components["schemas"]["__schema180"] | null;
            parent: components["schemas"]["__schema170"] | null;
        ...
        __schema181: {
            facts: components["schemas"]["__schema182"][];
            id: components["schemas"]["__schema170"];
            image?: components["schemas"]["__schema178"];
            meta: string;
            primary_action: components["schemas"]["__schema183"] | null;
            secondary_actions: components["schemas"]["__schema183"][];
            source_connection: components["schemas"]["__schema170"] | null;
            title: components["schemas"]["__schema171"];
        };
        __schema182: {
            label: components["schemas"]["__schema171"];
        ...
        __schema183: {
            handle: components["schemas"]["__schema170"];
            /** @enum {string} */
        ...
        __schema184: {
            ...
            undo?: {
                handle: components["schemas"]["__schema170"];
                valid_until: components["schemas"]["__schema174"];
            };
            what: components["schemas"]["__schema171"];
            when: components["schemas"]["__schema174"];
            where: components["schemas"]["__schema171"];
        };
        __schema185: {
            conversation_id: components["schemas"]["__schema170"];
            created_at: components["schemas"]["__schema174"];
            draft?: components["schemas"]["__schema187"];
            id: components["schemas"]["__schema170"];
            options: components["schemas"]["__schema186"][];
            preview: components["schemas"]["__schema181"] | null;
            version: components["schemas"]["__schema170"];
            what: components["schemas"]["__schema171"];
            why: components["schemas"]["__schema171"][];
        };
        /** @enum {string} */
        __schema186: "allow_once" | "always" | "deny";
        __schema187: {
            bcc?: components["schemas"]["__schema171"][];
            body: string;
            cc?: components["schemas"]["__schema171"][];
            /** @enum {string} */
            channel: "email" | "message";
            connection_id: components["schemas"]["__schema170"];
            id: components["schemas"]["__schema170"];
            recipient: components["schemas"]["__schema171"];
            /** @enum {string} */
        ...
        __schema188: {
            ...
            created_at: components["schemas"]["__schema174"];
            id: components["schemas"]["__schema170"];
            if_ignored: components["schemas"]["__schema171"];
            options: components["schemas"]["__schema189"];
            text: components["schemas"]["__schema171"];
            why: components["schemas"]["__schema171"][];
        };
        __schema189: components["schemas"]["__schema190"][];
        __schema190: {
            id: components["schemas"]["__schema170"];
            label: components["schemas"]["__schema171"];
        };
        __schema191: {
            ...
            recipient_class: components["schemas"]["__schema171"];
            text: components["schemas"]["__schema171"];
            used: components["schemas"]["__schema175"];
        };
        __schema192: {
            /** @constant */
            status: "ok";
        ...
        __schema193: {
            ...
            name: components["schemas"]["__schema194"];
            role: components["schemas"]["__schema195"];
            space_id: components["schemas"]["__schema170"];
            standing_instruction: components["schemas"]["__schema200"];
            surface: components["schemas"]["__schema197"];
            tone: components["schemas"]["__schema199"];
            usage: {
                conversations: components["schemas"]["__schema175"];
                last_used: components["schemas"]["__schema174"] | null;
            };
        };
        __schema194: string;
        __schema195: string;
        __schema196: string;
        /** @enum {string} */
        __schema197: "rounded" | "blob" | "diamond" | "octagon" | "gear";
        __schema198: string;
        __schema199: string;
        __schema200: string;
        __schema201: components["schemas"]["__schema170"][] | null;
        __schema202: boolean;
        __schema203: components["schemas"]["__schema178"];
        __schema204: {
            agent: components["schemas"]["__schema193"];
        };
        __schema205: {
            created: components["schemas"]["__schema174"];
            editable: boolean;
            id: components["schemas"]["__schema170"];
        ...
        __schema207: {
            category: components["schemas"]["__schema171"];
            conversation_ids: components["schemas"]["__schema170"][];
            file_ids: components["schemas"]["__schema170"][];
            id: components["schemas"]["__schema170"];
            milestones: {
                assignee: {
                    /** @constant */
                ...
                id: components["schemas"]["__schema170"];
                schedule_at?: components["schemas"]["__schema174"];
                status: components["schemas"]["__schema172"];
                title: components["schemas"]["__schema171"];
            }[];
            next_step: components["schemas"]["__schema171"] | null;
            progress_percent: number;
            title: components["schemas"]["__schema171"];
            updated_at: components["schemas"]["__schema174"];
        };
        __schema208: {
            plan: components["schemas"]["__schema207"];
        };
        __schema209: {
            profile: {
                day_hours: {
        ...
        __schema211: {
            task: components["schemas"]["__schema210"];
        };
        __schema212: {
            enabled: boolean;
            id: components["schemas"]["__schema170"];
            ...
            schedule: components["schemas"]["__schema171"];
            title: components["schemas"]["__schema171"];
        };
        __schema213: {
            automation: components["schemas"]["__schema212"];
        };
        __schema214: {
            session: {
                id: components["schemas"]["__schema170"];
                preview_frame: components["schemas"]["__schema178"] | null;
                /** @enum {string} */
                status: "working" | "needs_you" | "done" | "stopped";
                task_label: components["schemas"]["__schema171"];
                url: components["schemas"]["__schema178"];
            };
        };
        __schema215: {
        ...
        __schema216: {
            ...
            budget: components["schemas"]["__schema227"];
            cadence_multiplier: number;
            constraints: components["schemas"]["__schema222"];
            created_at: components["schemas"]["__schema113"];
            created_by: components["schemas"]["__schema228"];
            /** @default [] */
            deferred_questions: {
                because: components["schemas"]["__schema232"];
                blocks_external_effect: components["schemas"]["__schema235"];
                created_at: components["schemas"]["__schema113"];
                deadline_at: components["schemas"]["__schema236"];
                if_ignored: components["schemas"]["__schema234"];
            ...
            lease_epoch: components["schemas"]["__schema224"];
            next_wake_at: components["schemas"]["__schema225"];
            objective: components["schemas"]["__schema221"];
            principal_id?: components["schemas"]["__schema219"];
            revision: components["schemas"]["__schema223"];
            /** @enum {string} */
            scheduling_class: "interactive" | "background" | "quiet";
            space_id: components["schemas"]["__schema218"];
            state: components["schemas"]["JobState"];
            state_version: components["schemas"]["__schema229"];
            substrate_disposition: components["schemas"]["__schema230"];
            title: components["schemas"]["__schema220"];
            unread_results: number;
            unread_threshold: number;
            updated_at: components["schemas"]["__schema113"];
            visible_status: components["schemas"]["JobState"] | ("frequency_reduced" | "needs_attention");
            wait: components["schemas"]["__schema226"];
        };
        __schema217: string;
        __schema218: string;
        ...
        __schema223: number;
        __schema224: number;
        __schema225: components["schemas"]["__schema113"] | null;
        __schema226: {
            /** @constant */
            kind: "none";
        } | {
            ...
            /** @constant */
            kind: "timer";
            wake_at: components["schemas"]["__schema113"];
        } | {
            deadline_at: components["schemas"]["__schema113"] | null;
            /** @constant */
            kind: "event";
            trigger_id: string;
        };
        ...
        /** @enum {string} */
        __schema228: "owner" | "trigger" | "system";
        __schema229: number;
        /** @enum {string} */
        __schema230: "remote_recoverable" | "timer_or_event" | "local_process_interrupted" | "external_uncertain";
        __schema231: string;
        __schema232: components["schemas"]["__schema233"][];
        __schema233: string;
        __schema234: string;
        /** @default false */
        __schema235: boolean;
        /** @default null */
        __schema236: components["schemas"]["__schema113"] | null;
        __schema237: components["schemas"]["__schema189"];
        __schema238: {
            event_cursor: number | null;
            input_digest: components["schemas"]["__schema240"] | null;
            job_id: string | null;
            job_revision: number | null;
            /** @enum {string} */
            state: "accepted" | "rejected" | "unknown_durability";
            submission_id: components["schemas"]["__schema239"];
        };
        __schema239: string;
        __schema240: string;
        __schema241: {
            answer: string | null;
            answered_at: components["schemas"]["__schema113"] | null;
            attempt_id: string | null;
            because: components["schemas"]["__schema232"];
            blocks_external_effect: components["schemas"]["__schema235"];
            created_at: components["schemas"]["__schema113"];
        ...
        __schema242: {
            actions: {
                dispatched_at: components["schemas"]["__schema113"] | null;
                id: string;
                job_id: string;
            ...
            cursor: number;
            epoch: number | null;
            jobs: components["schemas"]["__schema216"][];
        };
        __schema243: {
            [key: string]: components["schemas"]["__schema244"];
        };
        __schema244: (string | number | boolean | null) | components["schemas"]["__schema244"][] | {
            [key: string]: components["schemas"]["__schema244"];
        };
        __schema245: {
            due_at: components["schemas"]["__schema113"];
            id: string;
            job_id: string;
            /** @enum {string} */
            kind: "timer" | "remote_task" | "local_process";
            operation_key: components["schemas"]["__schema239"];
            remote_ref: string | null;
            result: components["schemas"]["__schema243"] | null;
            /** @enum {string} */
        ...
        __schema246: {
            acknowledged_at: components["schemas"]["__schema113"] | null;
            coalesce_key: string;
            created_at: components["schemas"]["__schema113"];
            fulfilled_at: components["schemas"]["__schema113"] | null;
            id: string;
            job_id: string | null;
            /** @enum {string} */
            kind: "direct" | "quiet";
        ...
        __schema247: {
            attempted_at: components["schemas"]["__schema113"] | null;
            ...
            content_hash: components["schemas"]["__schema240"];
            created_at: components["schemas"]["__schema113"];
            delivered_at: components["schemas"]["__schema113"] | null;
        ...
        __schema248: {
            ...
            eligibility_generation: components["schemas"]["__schema253"];
            event_at: components["schemas"]["__schema113"];
            ingested_at: components["schemas"]["__schema113"];
            origin_trust: components["schemas"]["__schema254"];
            owner_id: string;
            publisher: components["schemas"]["__schema250"];
            source_id: components["schemas"]["__schema249"];
            source_identity: components["schemas"]["__schema250"];
            /** @enum {string} */
            source_type: "message" | "document" | "observation" | "receipt" | "assistant" | "owner_edit";
            source_version: components["schemas"]["__schema250"];
            space_id: string;
            /** @enum {string} */
            state: "active" | "suppressed" | "deleted" | "revoked";
            stream: components["schemas"]["__schema250"];
            stream_sequence: components["schemas"]["__schema251"];
        };
        __schema249: string;
        __schema250: string;
        __schema251: number;
        /** @enum {string} */
        __schema252: "private" | "space" | "public";
        __schema253: number;
        /** @enum {string} */
        __schema254: "owner" | "verified_connector" | "external_content" | "inferred" | "unknown";
        __schema255: {
            access_generation: components["schemas"]["__schema253"];
            data_revision: components["schemas"]["__schema253"];
            eligibility_generation: components["schemas"]["__schema253"];
            policy_generation: components["schemas"]["__schema253"];
        ...
        __schema258: string;
        /** @enum {string} */
        __schema259: "user_statement" | "document_assertion" | "checked_fact" | "inferred" | "preference" | "exception" | "historical";
        /** @enum {string} */
        __schema260: "attributed" | "checked" | "tentative" | "disputed";
        /** @enum {string} */
        __schema261: "active" | "superseded" | "historical" | "retracted" | "disputed";
        __schema262: {
            end: components["schemas"]["__schema251"];
            source_id: components["schemas"]["__schema249"];
            source_version: components["schemas"]["__schema250"];
            start: components["schemas"]["__schema253"];
        };
        __schema263: {
            claim_id: components["schemas"]["__schema256"];
            content: string | null;
        ...
        __schema265: string;
        /** @default null */
        __schema266: components["schemas"]["__schema258"] | null;
        __schema267: boolean;
        __schema268: string;
        __schema269: string;
        __schema270: {
        ...
        __schema271: {
            description: string;
            field: string;
            handle: (components["schemas"]["__schema257"] | string) | null;
            origin_trust: components["schemas"]["__schema254"];
            value: string;
        };
        __schema272: string;
        ...
        __schema281: {
            reactions: components["schemas"]["__schema280"][];
        };
        __schema282: string;
        __schema283: string;
        __schema284: number;
        ...
        __schema290: components["schemas"]["__schema113"] | null;
        __schema291: ("completed" | "waiting_for_input" | "waiting_for_approval" | "waiting_for_event_or_time" | "failed" | "budget_exhausted" | "fenced" | "unknown_check") | null;
        __schema292: components["schemas"]["__schema243"] | null;
        ...
        /** @enum {string} */
        __schema298: "job_created" | "job_state_changed" | "attempt_started" | "attempt_ended" | "turn_started" | "text_delta" | "tool_call_proposed" | "tool_result" | "action_requested" | "action_status_changed" | "approval_requested" | "approval_decided" | "knowledge_changed" | "notice" | "reaction" | "gap" | "hook_event" | "hook_error";
        __schema299: string;
        __schema300: string;
        __schema301: string;
        /** @enum {string} */
        __schema302: "completed" | "parked_until_retry" | "needs_reconciliation" | "needs_reconnect" | "needs_input" | "repair_exhausted";
        __schema303: {
            [key: string]: number;
        };
        __schema304: {
            at: components["schemas"]["__schema113"];
            attempt: number;
            /** @default null */
            ...
            detail: string;
            /** @default null */
            fault_kind: components["schemas"]["__schema305"] | null;
            payload_hash: components["schemas"]["__schema300"];
            /** @default null */
            retry_after: components["schemas"]["__schema113"] | null;
            /** @default null */
            route: string | null;
        }[];
        /** @enum {string} */
        __schema305: "transient_before_dispatch" | "rate_limited" | "expired_credential" | "revoked_credential" | "schema_drift" | "unsupported_route" | "uncertain_outcome" | "bad_output" | "unclassified";
        __schema306: string;
        __schema307: string;
        __schema308: string;
        __schema309: string;
        __schema310: string;
        /** @default null */
        __schema311: components["schemas"]["__schema301"] | null;
        __schema312: string | null;
        __schema313: string | null;
        __schema314: string;
        __schema315: components["schemas"]["__schema113"] | null;
        __schema316: components["schemas"]["__schema243"] | null;
        __schema317: components["schemas"]["__schema113"] | null;
        __schema318: components["schemas"]["__schema243"] | null;
        /** @default [] */
        __schema319: components["schemas"]["__schema304"];
        /** @default {} */
        __schema320: components["schemas"]["__schema303"];
        /** @default null */
        __schema321: components["schemas"]["__schema302"] | null;
        /** @default null */
        __schema322: components["schemas"]["__schema113"] | null;
        __schema323: {
        ...
        __schema325: string;
        /** @enum {string} */
        __schema326: "imap" | "smtp" | "caldav" | "web" | "files" | "test" | "exec" | "artifacts" | "generation" | "mcp" | "sandbox";
        __schema327: string;
        __schema328: string[];
        /** @enum {string} */
        __schema329: "active" | "disabled" | "error" | "revoked";
        /** @enum {string} */
        __schema330: "unknown" | "ok" | "degraded" | "failing";
        /** @enum {string} */
        __schema331: "available" | "connecting" | "connected" | "error";
        __schema332: number;
        __schema333: boolean;
        __schema334: string[];
        __schema335: components["schemas"]["__schema113"] | null;
        __schema336: {
            check?: components["schemas"]["ConnectionCheck"];
            connection: components["schemas"]["Connection"];
        };
        ...
        __schema347: string;
        /** @enum {string} */
        __schema348: "mail" | "caldav" | "ics" | "mcp" | "mcp_stdio" | "sandbox";
        __schema349: string;
        __schema350: string;
        __schema351: {
            path: string;
            value: components["schemas"]["__schema352"];
        }[];
        __schema352: string | number | boolean;
        __schema353: components["schemas"]["ConnectionFormField"][];
        __schema354: string;
        __schema355: string;
        __schema356: string;
        __schema357: boolean;
        __schema358: boolean;
        __schema359: string;
        __schema360: components["schemas"]["__schema352"];
        __schema361: {
            label: string;
            value: string;
        }[];
        __schema362: components["schemas"]["__schema363"] | "list";
        /** @enum {string} */
        __schema363: "text" | "email" | "url" | "number" | "password" | "checkbox" | "select" | "string_list";
        __schema364: {
            default?: components["schemas"]["__schema360"];
            help?: components["schemas"]["__schema356"];
            input: components["schemas"]["__schema363"];
            label: components["schemas"]["__schema355"];
            options?: components["schemas"]["__schema361"];
            path: components["schemas"]["__schema354"];
            placeholder?: components["schemas"]["__schema359"];
            required: components["schemas"]["__schema357"];
            secret: components["schemas"]["__schema358"];
        }[];
        __schema365: {
            asks_first: boolean;
            default: boolean;
        ...
        /** @enum {string} */
        __schema366: "fact" | "preference" | "decision" | "procedure" | "reference" | "event";
        /** @enum {string} */
        __schema367: "active" | "superseded" | "retracted" | "disputed";
        __schema368: {
            body: string;
        ...
        __schema371: string;
        /** @enum {string} */
        __schema372: "private" | "space" | "public";
        /** @enum {string} */
        __schema373: "high" | "medium" | "low";
        /** @enum {string} */
        __schema374: "user" | "agent" | "document" | "tool";
        __schema375: {
            /** @enum {string} */
            kind: "statement" | "file" | "url" | "tool_output";
            /** @default  */
        ...
        __schema376: string;
        /** @default null */
        __schema377: components["schemas"]["__schema376"] | null;
        /** @default [] */
        __schema378: components["schemas"]["__schema369"][];
        /** @default null */
        __schema379: components["schemas"]["__schema369"] | null;
        /** @default [] */
        __schema380: string[];
        /** @default [] */
        __schema381: components["schemas"]["__schema369"][];
        /** @constant */
        __schema382: 1;
        __schema383: string;
        __schema384: string;
        __schema385: number;
        /** @enum {string} */
        __schema386: "automation" | "human";
        /** @constant */
        __schema387: true;
        __schema388: components["schemas"]["BrowserSite"][];
        __schema389: string;
        __schema390: string;
        __schema391: string;
        __schema392: string;
        ...
        __schema405: {
            /** @default null */
            currency: components["schemas"]["__schema407"] | null;
            domain: string;
            first_seen_at: components["schemas"]["__schema113"];
            id: string;
            last_seen_at: components["schemas"]["__schema113"];
            message_count: number;
            /** @default null */
            monthly_spend_minor: components["schemas"]["__schema406"] | null;
            name: string;
            space_id: string;
        };
        __schema406: number;
        ...
        __schema408: {
            /** @default null */
            amount_minor: components["schemas"]["__schema406"] | null;
            company_id: string;
            confidence: components["schemas"]["__schema373"];
            /** @default null */
            currency: components["schemas"]["__schema407"] | null;
            /** @enum {string} */
            direction: "owed_to_you" | "you_pay" | "you_owe" | "info";
            /** @default null */
            due_at: components["schemas"]["__schema113"] | null;
            due_date_only?: boolean;
            evidence: components["schemas"]["__schema409"][];
            id: string;
            /** @default null */
            job_id: string | null;
            /** @enum {string} */
        ...
        __schema410: {
            ...
            account: components["schemas"]["__schema411"] | null;
            /** @description When the current access token expires. The gateway refreshes before then. */
            expires_at: components["schemas"]["__schema113"] | null;
            /** @description The provider as the person knows it, for a "Sign in with" button */
            label: string;
            /** @description What happened and what to do, in plain words, whenever the person has something to do; null when signed in or signed out. */
            message: components["schemas"]["__schema413"] | null;
            methods: ("device" | "browser")[];
            /** @enum {string} */
            provider: "chatgpt" | "openai-compatible";
            /** @description Why a new sign-in is needed */
            reason: components["schemas"]["__schema412"] | null;
            /**
        ...
        __schema411: string;
        /** @enum {string} */
        __schema412: "refresh_expired" | "refresh_reused" | "refresh_revoked" | "refresh_refused" | "access_expired";
        __schema413: string;
        __schema414: string;
        __schema415: number;
        __schema416: string;
        ...
        __schema420: {
            captured_at: components["schemas"]["__schema113"];
            duration_ms: number | null;
        };
        /** @enum {string} */
        __schema421: "started" | "succeeded" | "failed" | "interrupted" | "observed" | "unknown";
        ...
        Action: {
            ...
            authorization_ref: components["schemas"]["__schema312"];
            budget_reservation: components["schemas"]["__schema313"];
            canonical_payload: components["schemas"]["__schema243"];
            connection_id: components["schemas"]["__schema309"];
            created_at: components["schemas"]["__schema113"];
            dispatched_at: components["schemas"]["__schema315"];
            effect_class: components["schemas"]["EffectClass"];
            id: components["schemas"]["__schema306"];
            idempotency_key: components["schemas"]["__schema314"];
            intent_key: components["schemas"]["__schema311"];
            job_id: components["schemas"]["__schema307"];
            kind: components["schemas"]["__schema310"];
            payload_hash: components["schemas"]["__schema300"];
            receipt: components["schemas"]["__schema316"];
            reconciliation: components["schemas"]["__schema318"];
            repair_counters: components["schemas"]["__schema320"];
            repair_disposition: components["schemas"]["__schema321"];
            repair_trace: components["schemas"]["__schema319"];
            resolved_at: components["schemas"]["__schema317"];
            retry_after_at: components["schemas"]["__schema322"];
            status: components["schemas"]["ActionStatus"];
        };
        /** @enum {string} */
        ActionStatus: "proposed" | "needs_approval" | "approved" | "denied" | "admitted" | "dispatched" | "succeeded" | "failed" | "unknown" | "unresolved";
        Attempt: {
            context_snapshot_ref: components["schemas"]["__schema293"];
            ended_at: components["schemas"]["__schema290"];
            epoch: components["schemas"]["__schema284"];
            id: components["schemas"]["__schema282"];
            job_id: components["schemas"]["__schema283"];
            model: components["schemas"]["__schema287"];
            model_actual: components["schemas"]["__schema288"];
            outcome: components["schemas"]["__schema291"];
            outcome_detail: components["schemas"]["__schema292"];
            provider: components["schemas"]["__schema286"];
            runtime_version: components["schemas"]["__schema285"];
            started_at: components["schemas"]["__schema113"];
            usage: components["schemas"]["__schema289"];
        };
        BrowserControlResponse: {
            control: components["schemas"]["__schema386"];
            control_epoch: components["schemas"]["__schema385"];
            fresh_observation_required: components["schemas"]["__schema387"];
            session_id: components["schemas"]["__schema384"];
        };
        BrowserSite: {
            domain: components["schemas"]["__schema389"];
            label: components["schemas"]["__schema390"];
            last_used: components["schemas"]["__schema391"];
        };
        BrowserSiteForgotten: {
            domain: components["schemas"]["__schema392"];
            forgotten: components["schemas"]["__schema393"];
        };
        BrowserSiteList: {
            sites: components["schemas"]["__schema388"];
        };
        Connection: {
            builtin?: components["schemas"]["__schema333"];
            created_at: components["schemas"]["__schema113"];
            generation?: components["schemas"]["__schema332"];
            health: components["schemas"]["__schema330"];
            id: components["schemas"]["__schema324"];
            label: components["schemas"]["__schema327"];
            last_checked_at: components["schemas"]["__schema335"];
            needs_scope?: components["schemas"]["__schema334"];
            provider: components["schemas"]["__schema326"];
            scopes: components["schemas"]["__schema328"];
            setup_state?: components["schemas"]["__schema331"];
            space_id: components["schemas"]["__schema325"];
            status: components["schemas"]["__schema329"];
        };
        ConnectionCheck: {
            checked_at: components["schemas"]["__schema113"];
            code: components["schemas"]["__schema338"];
            detail: components["schemas"]["__schema339"];
            status: components["schemas"]["__schema337"];
        };
        ConnectionFormField: {
            default?: components["schemas"]["__schema360"];
            help?: components["schemas"]["__schema356"];
            input: components["schemas"]["__schema362"];
            item_fields?: components["schemas"]["__schema364"];
            label: components["schemas"]["__schema355"];
            options?: components["schemas"]["__schema361"];
            path: components["schemas"]["__schema354"];
            placeholder?: components["schemas"]["__schema359"];
        ...
        ConnectionKind: {
            description: components["schemas"]["__schema350"];
            fields: components["schemas"]["__schema353"];
            fixed: components["schemas"]["__schema351"];
            id: components["schemas"]["__schema347"];
            kind: components["schemas"]["__schema348"];
            scopes: components["schemas"]["__schema365"];
            title: components["schemas"]["__schema349"];
        };
        /** @enum {string} */
        EffectClass: "read" | "write_reversible" | "write_external" | "spend";
        Event: {
            attempt_id: components["schemas"]["__schema297"];
            created_at: components["schemas"]["__schema113"];
            dedup_key: components["schemas"]["__schema299"];
            job_id: components["schemas"]["__schema296"];
            payload: components["schemas"]["__schema243"];
            seq: components["schemas"]["__schema295"];
            type: components["schemas"]["__schema298"];
        };
        HookObservation: {
            capture_id: components["schemas"]["__schema417"];
            detail?: components["schemas"]["__schema423"];
            name: components["schemas"]["__schema418"];
            outcome: components["schemas"]["__schema421"];
            redacted_args_digest: components["schemas"]["__schema422"];
            timing: components["schemas"]["__schema420"];
            tool_name: components["schemas"]["__schema419"];
        };
        Job: {
            budget: components["schemas"]["__schema227"];
            constraints: components["schemas"]["__schema222"];
        ...
        KnowledgeFrontmatterOutput: {
            asserted_by: components["schemas"]["__schema374"];
            audience: components["schemas"]["__schema372"];
            confidence: components["schemas"]["__schema373"];
            created: components["schemas"]["__schema376"];
            id: components["schemas"]["__schema369"];
            links: components["schemas"]["__schema381"];
            observed_at: components["schemas"]["__schema376"];
            schema_version: components["schemas"]["__schema382"];
            source: components["schemas"]["__schema375"];
            space: components["schemas"]["__schema371"];
            status: components["schemas"]["__schema367"];
            superseded_by: components["schemas"]["__schema379"];
            supersedes: components["schemas"]["__schema378"];
            tags: components["schemas"]["__schema380"];
            title: components["schemas"]["__schema370"];
            type: components["schemas"]["__schema366"];
            updated: components["schemas"]["__schema376"];
            valid_from: components["schemas"]["__schema376"];
            valid_until: components["schemas"]["__schema377"];
        };
        LiveClose: {
            live_id: components["schemas"]["__schema84"];
        };
        LiveClosed: {
            closed: components["schemas"]["__schema403"];
        };
        LiveInputResponse: {
            accepted: components["schemas"]["__schema400"];
        };
        LiveOpen: {
            control_epoch: components["schemas"]["__schema395"];
            expires_at: components["schemas"]["__schema399"];
            live_id: components["schemas"]["__schema394"];
            site_scope: components["schemas"]["__schema397"];
            viewport: components["schemas"]["__schema396"];
        };
        LiveScope: {
            host: components["schemas"]["__schema92"];
            live_id: components["schemas"]["__schema84"];
        };
        LiveScopeResponse: {
        ...
        Plugin: {
            description: components["schemas"]["__schema342"];
            fields: components["schemas"]["__schema344"];
            id: components["schemas"]["__schema340"];
            installed: components["schemas"]["__schema346"];
            title: components["schemas"]["__schema341"];
            tools: components["schemas"]["__schema345"];
            version: components["schemas"]["__schema343"];
        };
        RuntimeEvent: {
            at: components["schemas"]["__schema113"];
            attempt_id: components["schemas"]["__schema414"];
            capture_id: components["schemas"]["__schema417"];
            dedup_key: components["schemas"]["__schema416"];
            detail?: components["schemas"]["__schema423"];
            local_seq: components["schemas"]["__schema415"];
            name: components["schemas"]["__schema418"];
            outcome: components["schemas"]["__schema421"];
            redacted_args_digest: components["schemas"]["__schema422"];
            timing: components["schemas"]["__schema420"];
            ...
            arguments: components["schemas"]["__schema243"];
            at: components["schemas"]["__schema113"];
            attempt_id: components["schemas"]["__schema414"];
            call_id: string;
            dedup_key: components["schemas"]["__schema416"];
            ...
            local_seq: components["schemas"]["__schema415"];
            ok: boolean;
            result: components["schemas"]["__schema243"];
            /** @constant */
            type: "tool_result";
        } | {
            action_id: string;
            ...
            outcome: {
                ...
                action_ids: components["schemas"]["__schema424"][];
                /** @constant */
        ...
        Space: {
            audience: components["schemas"]["__schema147"];
            created_at: components["schemas"]["__schema113"];
            git_path: components["schemas"]["__schema149"];
            id: components["schemas"]["__schema144"];
            kind: components["schemas"]["__schema146"];
            name: components["schemas"]["__schema145"];
            owner_principal_id?: components["schemas"]["__schema148"];
        };
        SpaceRemoval: {
            blocked_reason: components["schemas"]["__schema158"];
            counts: components["schemas"]["__schema157"];
            finished_at: components["schemas"]["__schema159"];
            id: components["schemas"]["__schema151"];
            kind: components["schemas"]["__schema154"];
            phase: components["schemas"]["__schema156"];
            space_id: components["schemas"]["__schema152"];
            space_name: components["schemas"]["__schema153"];
            started_at: components["schemas"]["__schema113"];
            state: components["schemas"]["__schema155"];
        };
        SpaceRemovalPreview: {
            confirmation: components["schemas"]["__schema165"];
            counts: components["schemas"]["__schema162"];
            kind: components["schemas"]["__schema154"];
            name: components["schemas"]["__schema161"];
            providers: components["schemas"]["__schema163"];
            space_id: components["schemas"]["__schema160"];
            stays: components["schemas"]["__schema164"];
        };
        SpaceRemovalReport: {
            cleared: components["schemas"]["__schema167"];
            headline: components["schemas"]["__schema166"];
            removal: components["schemas"]["SpaceRemoval"];
            still_yours: components["schemas"]["__schema168"];
        };
    };
    responses: never;
    parameters: never;
